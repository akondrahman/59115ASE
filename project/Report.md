...
|-----|-----|-----|
|MultiplierSchedulePressure, MultiplierWorkforce, NominalErr, SoftwareDevelopmentRate, PotentialErrorDetectRate, QARate, AvgErrorPerTask, ActualReworkMP, DailyMPRework, TimeToSmooth, MultiplierToRegeneration, ActiveErrorDensity, TestingRate, PassiveErrorDensity, FractionEscapingErrors, ActiveErrorsRetiringFraction, BadFixGenRate    |   |   PotentiallyDetectableError, DetectedError, EscapedError, ReworkedError, UndetectedActiveErrors, UndetectedPassiveErrors|
